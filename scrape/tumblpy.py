...
class Tumblpy(object):
    ...
    def request(self, endpoint, method='GET', blog_url=None, tag=None,
    ...
    def get(self, endpoint, blog_url=None,tag=None, extra_endpoints=None, params=None):
        return self.request(endpoint, blog_url=blog_url, tag=tag,
